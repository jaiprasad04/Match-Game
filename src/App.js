...
class App extends Component {
  ...
  render() {
    const {activeImage, activeTabId, score, startTime, isGameInProgress} =
      this.state
    ...
    return (
      <div className="app-container">
        <Header score={score} startTime={startTime} />
        {isGameInProgress ? (
          <div className="container">
            <img src={imageUrl} alt="match" className="active-image" />
